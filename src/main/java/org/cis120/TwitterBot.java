...
public class TwitterBot {
    ...
    public void writeStringsToFile(
        ...
        try {
            ...
            System.out.println("ERROR MESSAGE: NO SUCH FILE");
        }
        // Complete this method.
    }
    ...
    public String generateTweet(int numWords) {
        ...
        if (!mc.hasNext()) {
            ...
            for (int i = 0; i < numWords; i++) {
                if (mc.hasNext()) {
                    String nextTweet = this.mc.next();
                    if (i == 0) {
                        tweet = new StringBuilder(nextTweet);
                    } else {
                        if (nextTweet == null) {
            ...
            return tweet + randomPunctuation();
        }
    }
